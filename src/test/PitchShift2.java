...
public class PitchShift2 {
	...
	public PitchShift2(Wavefile wf,int fftSize,int fftOverlap) throws LineUnavailableException{
		this(wf.getFloatData(),(double)wf.getSampleRate(),fftSize,fftOverlap);
	}
	public PitchShift2(float[] d,  double sampleRate, int size, int overlap) throws LineUnavailableException{
		/*
